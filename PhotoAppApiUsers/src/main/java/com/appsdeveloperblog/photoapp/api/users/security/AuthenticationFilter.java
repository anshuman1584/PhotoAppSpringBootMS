...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter{
	...
	protected void successfulAuthentication(HttpServletRequest req,
		...
		System.out.println("Time 0 --> "+environment);
		System.out.println("Time 1 --> "+environment.getProperty("token.expiration_time"));
		System.out.println("Time 2 --> "+Long.parseLong(environment.getProperty("token.expiration_time")));
